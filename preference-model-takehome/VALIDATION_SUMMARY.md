...
- **Reward Signal:** Binary (pass/fail)
- **Reward Magnitude:** Clear separation (43% error vs 0.1% error)
- **Deterministic:** Same code → same reward (reproducible)
- **Episode Length:** Single-step (edit code → grade → done)
